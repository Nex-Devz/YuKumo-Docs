...
YuKumo has **zero runtime dependencies** — what you install is what you get.
...
YuKumo needs voice state data from Discord to establish connections. Forward both events:
...
See working bots in the [examples directory](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples):

- [discord.js](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples/discordjs)
- [Seyfert](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples/seyfert)
- [Eris](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples/eris)
- [Oceanic.js](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples/oceanic)
- [Discordeno](https://github.com/Nex-Devz/YuKumo-Docs/tree/main/examples/discordeno)
